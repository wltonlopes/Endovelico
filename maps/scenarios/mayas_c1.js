...
{
	let infIntrudersC = ["units/zapo/infantry_javelineer_b","units/zapo/infantry_spearman_b"]
	var intruders = TriggerHelper.SpawnUnitsFromTriggerPoints(
...
Trigger.prototype.Rain = function()
{
	let rainAndClouds = ["actor|particle/rain_shower_diagonal","actor|particle/cloud"]
	TriggerHelper.SpawnUnitsFromTriggerPoints(
		pickRandom(["F"]),pickRandom(infIntrudersC), 1, 0);
};
...
cmpTrigger.DoAfterDelay(35000, "Rain", {});
